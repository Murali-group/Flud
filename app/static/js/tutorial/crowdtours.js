...
tours[ 1 ].addStep( 'welcome_controls', {
  ...
  text: 'Let us start with the tutorial.',
  buttons: [ {
    text: 'Next',
    classes: 'btn btn-primary',
    action: tours[ 1 ].next
...
tours[ 1 ].addStep( 'edge', {
  ...
  buttons: [ {
    ...
    classes: 'btn btn-primary',
    action: function () {
      tutorial.unhighlight( cy.edges( '[name = "1847-1848"]' ) );
      $( '#cy' ).css( 'z-index', 3 );
      tours[ 1 ].back();
    }
  }, {
...
tours[ 1 ].addStep( 'time_left', {
  title: 'Minutes left',
  text: [ 'Each game expires in an hour. Your aim is to achieve a score as high as possible in the given time.',
...
tours[ 1 ].addStep( 'finished', {
  title: 'Finish game',
  text: 'Each game automatically expires in an hour. However, you can end the game at point of time by clicking the `Finished` button.',
...
tours[ 1 ].addStep( 'complete_tutorial', {
  ...
  text: [ 'Congratulations!  You have successfully completed the tutorial. Now try to beat the top score by a big margin!',
