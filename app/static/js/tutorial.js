...
var tutorial = {
  ...
  highlight: function ( eles ) {
    eles.each( function ( ele ) {
      if ( ele.isNode() ) {
        ...
        ele.style( 'width', 1.5 * EDGE_WIDTH );
      }
    } )
  },
  unhighlight: function ( eles ) {
    eles.each( function ( ele ) {
      if ( ele.isNode() ) {
        ele.style( 'background-color', '#809fff' );
      } else {
        ele.style( 'line-color', DPP_COLOR );
        ele.style( 'target-arrow-color', DPP_COLOR );
        ele.style( 'width', EDGE_WIDTH );
      }
    } )
  },
